...
class Producto
{
    ...
    public static function obtenerProductoEnPedido($idProducto){
        $objAccesoDatos = AccesoDatos::obtenerInstancia();
        $consulta = $objAccesoDatos->prepararConsulta("SELECT productospedidos.id as id, productospedidos.idProducto as nombre, productospedidos.idEstado as estado, productospedidos.idUsuarioPreparacion as usuarioPreparacion, productospedidos.tiempoPreparacion as tiempoPreparacion, menu.idSector as sector FROM productospedidos JOIN menu on productospedidos.idProducto = menu.id WHERE productospedidos.id = :id;");
        $consulta->bindValue(':id', $idProducto, PDO::PARAM_INT);
        $consulta->execute();
